...
const Navbar = () => {
  ...
  // Affichage de la modale d'inscription
  ...
  // Callbacks pour GoogleSignInButton
          ...
          {user ? (
            <>
              <span className="navbar-text text-light me-3 d-flex align-items-center">
                <div
                  className="bg-white text-dark rounded-circle me-2 d-flex align-items-center justify-content-center"
                  style={{
                    width: '32px',
                    height: '32px',
                    fontWeight: 'bold',
